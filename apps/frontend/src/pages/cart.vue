...
const formattedSubtotal = computed(() => {
  return new Intl.NumberFormat('vi-VN', {
    style: 'currency',
    currency: 'VND'
  }).format(cartSummary.value?.subtotal || 0);
});
...
const formattedDiscount = computed(() => {
  return new Intl.NumberFormat('vi-VN', {
    style: 'currency',
    currency: 'VND'
  }).format(cartSummary.value?.totalDiscount || 0);
});
  ...
  <div class="cart-page">
    <div class="container mx-auto px-4 py-8">
      ...
      <div v-else-if="!isCartEnabled" class="text-center py-12">
        <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mb-6 inline-block">
          {{ t('cart.disabled') }}
        </div>
      </div>

      <!-- Empty Cart -->
      <div v-else-if="isEmpty" class="empty-cart text-center py-12">
      ...
      <div v-else class="cart-content">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-2">
            <div class="cart-items bg-white dark:bg-gray-800 rounded-lg shadow-sm">
              ...
              <div class="divide-y divide-gray-200 dark:divide-gray-700">
                <div
                  ...
                  :key="item.id"
                  class="cart-item p-6 flex gap-4"
                >
                  <!-- Product Image -->
                  ...
                  <div class="flex flex-col items-end gap-3">
                    <!-- Quantity Controls -->
                    <div class="quantity-controls flex items-center border border-gray-300 dark:border-gray-600 rounded-lg">
                      <button
                        @click="handleQuantityChange(item.id, item.quantity - 1)"
                        :disabled="item.quantity <= 1 || isProcessing"
                        class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <Minus class="w-4 h-4" />
                      </button>
          ...
          <div class="lg:col-span-1">
            <div class="order-summary bg-white dark:bg-gray-800 rounded-lg shadow-sm sticky top-4">
              <div class="p-6">
                ...
                <div class="space-y-3 mb-6">
                  ...
                  <div v-if="cartSummary && cartSummary.totalDiscount && cartSummary.totalDiscount > 0" class="flex justify-between text-green-600">
                ...
                <NuxtLink
                  to="/checkout"
                  class="w-full bg-primary hover:bg-primary-dark text-white py-3 px-6 rounded-lg font-medium text-center block transition-colors"
                >
                  {{ t('cart.checkout') }}
                </NuxtLink>
                ...
                <NuxtLink
                  to="/products"
                  class="w-full mt-3 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-900 dark:text-white py-3 px-6 rounded-lg font-medium text-center block transition-colors"
                >
