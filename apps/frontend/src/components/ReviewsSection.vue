...
<template>
  <section :class="backgroundColor" class="py-12 sm:py-16">
    <div class="container mx-auto px-4">
      ...
      <!-- Reviews grid -->
      <div v-else-if="hasReviews" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div 
          v-for="review in reviews" 
          :key="review.id"
          class="bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 rounded-lg p-6 flex flex-col"
        >
          <!-- Author info -->
          <div class="flex items-center mb-4">
            ...
            <!-- Service type badge -->
            <div v-if="review.serviceType" class="ml-auto">
