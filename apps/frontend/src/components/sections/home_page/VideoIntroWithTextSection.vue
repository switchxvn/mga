    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-col md:flex-row gap-8">
        ...
        <div 
          ...
          class="prose dark:prose-invert max-w-none flex-shrink-0 bg-white dark:bg-gray-800 shadow-lg flex flex-col"
        >
          <div v-html="config.description" class="prose-lg flex-grow"></div>
          ...
          <UButton
            ...
            color="primary"
            variant="solid"
            class="mt-8 inline-block transition-colors duration-300"
        ...
        >
          ...
          <div v-else-if="error" class="text-red-500 text-center p-4 h-[400px] flex items-center justify-center">
            {{ error.message }}
          </div>
          ...
          <div v-else class="h-[400px]">
            ...
            <TransitionGroup name="fade">
              <div
                ...
                class="h-full w-full bg-gray-900 rounded-lg overflow-hidden shadow-xl"
              >
                <!-- YouTube iframe -->
                <iframe
            ...
            >
              <button
                class="w-10 h-10 rounded-full bg-white/90 hover:bg-white text-primary-600 flex items-center justify-center opacity-75 hover:opacity-100 pointer-events-auto transition-all duration-300"
...
.video-intro-with-text .error {
  @apply text-red-500 bg-red-50 dark:bg-red-900/20 rounded-lg p-4;
}
</style> 