...
export class UpdateAboutSectionTypeEnumWithTourismGallery1743270380279 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TYPE about_section_type_enum ADD VALUE IF NOT EXISTS 'tourism_gallery';
    `);
  }
