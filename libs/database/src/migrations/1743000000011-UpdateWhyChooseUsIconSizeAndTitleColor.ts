...
export class UpdateWhyChooseUsIconSizeAndTitleColor1743000000011 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    const updatedSettings = {
      ...
      gap: '1rem',
      iconStyle: {
        height: '9rem', // Tăng kích thước icon
        color: {
          light: '#00A0DC',
          dark: '#00A0DC'
        },
        margin: '0 auto 2rem auto', // Tăng margin bottom
        hexagon: {
          size: '12rem', // Tăng kích thước hexagon
          background: {
            light: '#FFFFFF',
            dark: '#1a1a1a'
          },
          ...
          padding: '0.15rem' // Giảm padding để icon lớn hơn nữa
        }
      },
      titleStyle: {
        size: '2xl',
        ...
        fontWeight: '700',
        color: {
          light: '#00A0DC', // Màu trùng với icon
          dark: '#00A0DC' // Màu trùng với icon
        },
        margin: '0 0 1.5rem 0', // Tăng margin bottom
